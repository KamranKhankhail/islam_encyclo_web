...
import SnapchatFooterIcon from "@/icons/SnapchatFooterIcon";
...
const teamSocialIcons = [
  ...
  {
    icon: TiktokIcon,
    href: "https://www.tiktok.com/@islamencyclooffici?_t=ZS-90cdAqwxUYP&_r=1",
  },
...
export default function Footer() {
  ...
  return (
    <Stack
      sx={{
        background:
          "radial-gradient(349% 931.02% at -34.77% -168.23%, #FFFFFF 0%, rgba(192, 224, 224, 0.41) 50%, rgba(255, 255, 255, 0.42) 75%, rgba(149, 203, 203, 0.705) 87.5%, rgba(128, 192, 192, 0.59) 100%)",
    ...
    >
      ...
      >
        {" "}
        <IslamEncycloNavbarIcon width="100px" height="100px" />
      </Box>
      ...
      >
        ...
        >
          ...
          >
            Our mission is to educate, inspire, and guide through authentic
            Islamic resources for learners across the globe.
          </Typography>
          <Box sx={{ pt: "20px" }}>
            {" "}
            <Typography
